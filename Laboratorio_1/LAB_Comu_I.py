...
class LAB_Comu_I(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB_Comu_I")
        ...
        self._frequency_range = Range(-samp_rate/2, samp_rate/2, 100, 0, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1500, 0.1, 0, 0)
        self._amplitud_range = Range(0, 5, 1, 1, 200)
