...
# Author: Diego_Espinel_Diego_Garcia_G1C_02
...
class Lab1_punto2_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1_punto2_3")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 11000
        self.freq = freq = 1000

        ##################################################
        # Blocks
        ##################################################
        self._samp_rate_range = Range(1000, 80000, 1000, 11000, 200)
        ...
        self._freq_range = Range(1000, 40000, 1000, 1000, 200)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, "Frequency Signal", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Lab1_punto2_3, options=None):
