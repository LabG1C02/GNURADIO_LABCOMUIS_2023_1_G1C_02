...
class Lab_punto5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab1_punto5_audio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_punto5_audio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_punto5")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\ASUS\\Desktop\\audio.wav', True)
...
def main(top_block_cls=Lab_punto5, options=None):
